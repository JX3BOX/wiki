        ...
        >
            <template #default>
                <div class="m-more-action">
                    <span class="u-action" @click="onAddItemPlan">加入清单</span>
    ...
    computed: {
        ...
        drawerOptions() {
            return {
                ...
                laterOn: {
                    author_id: this.author_id || 0, // 作者 ID
